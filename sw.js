...
// Naikkan versi ke v3 agar browser membuang cache lama yang error
const CACHE_NAME = 'lapor-bencana-v3'; 

// Gunakan absolute path dari nama repo agar tidak nyasar
const ASSETS = [
  '/lapor-bencana/',
  '/lapor-bencana/index.html',
  '/lapor-bencana/css/style.css',
  '/lapor-bencana/js/app.js',
  '/lapor-bencana/manifest.json',
  '/lapor-bencana/icons/icon-192x192.png',
  '/lapor-bencana/icons/icon-512x512.png'
];
